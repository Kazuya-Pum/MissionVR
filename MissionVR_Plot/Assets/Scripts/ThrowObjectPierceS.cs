...
{
    public class ThrowObjectPierceS : ThrowObject
    {
        //[HideInInspector]
        //public int Damage = 0;
        //[HideInInspector]
        ...
        [HideInInspector]
        public string BombEffectHit = null;//着弾時発生オブジェクト
        [HideInInspector]
        public string BombEffectDestroy = null;
        //[HideInInspector]
        ...
        void Update()
        {
            ...
            {
                if (BombEffectDestroy != null)
                {
                    PhotonNetwork.Instantiate(BombEffectDestroy, transform.position, Quaternion.identity,0);
                }
        ...
        virtual public void OnTriggerEnter(Collider c)
        {
            ...
            //    p.Damage(Hit(Damage));
            //}
            if (BombEffectHit != null)
            {
                PhotonNetwork.Instantiate(BombEffectHit, transform.position, Quaternion.identity,0);
            }
