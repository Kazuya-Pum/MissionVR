...
#region Operations and Connection Methods
    ...
    protected internal void SetupProtocol(ServerConnection serverType)
    {
        ...
        socketTcp = System.Type.GetType("ExitGames.Client.Photon.SocketWebTcp, Assembly-CSharp",false);
        if (socketTcp == null)
        {
            socketTcp = System.Type.GetType("ExitGames.Client.Photon.SocketWebTcp, Assembly-CSharp-firstpass", false);
        }
        #endif
        if (socketTcp != null)
        {
